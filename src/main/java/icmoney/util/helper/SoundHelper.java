...
public class SoundHelper {
	...
	public static void playBlockPlaceSound(World world, EntityPlayer player, IBlockState state, Location location) {
		...
		player.world.playSound(player, location.getBlockPos(),
	...
	public static void playDing(World world, EntityPlayer player) {
		...
		player.world.playSound(player, player.getPosition(), SoundEvents.ENTITY_EXPERIENCE_ORB_PICKUP,
				SoundCategory.NEUTRAL, 1, 1);
	}

	public static void playClick(World world, EntityPlayer player) {

		player.world.playSound(player, player.getPosition(), SoundEvents.BLOCK_LEVER_CLICK, player.getSoundCategory(),
				1, 1);
	}

	public static void playClang(World world, EntityPlayer player) {

		player.world.playSound(player, player.getPosition(), SoundEvents.BLOCK_ANVIL_LAND, player.getSoundCategory(),
				0.9F, 1.1F);
	}
