package icmoney.inventory.base;
...
public class SlotFilter extends Slot {
	...
	private boolean isFilter(ItemStack stack) {
		 ...
		 * 
		 * if (item.getBlock().getClass().equals(objectFilter) ||
		 * item.getBlock().getClass().isInstance(objectFilter)) return true; }
		 * 
