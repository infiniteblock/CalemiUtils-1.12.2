...
public abstract class BlockInventoryContainerBase extends BlockContainerBase {
	...
	protected BlockInventoryContainerBase(String name, MaterialSound matSound, float hardness, int harvestLevel,
			float resistance) {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (!worldIn.isRemote) {
			...
			FMLNetworkHandler.openGui(playerIn, ICMoney.instance, 0, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
