...
public class BlockColoredBase extends Block implements IHasModel {
	...
	protected BlockColoredBase(String name, MaterialSound matSound, float hardness, int harvestLevel,
			float resistance) {
	...
	public void registerModels() {
		...
		for (int i = 0; i < EnumDyeColor.values().length; i++)
			ICMoney.proxy.registerItemRenderer(Item.getItemFromBlock(this), i,
